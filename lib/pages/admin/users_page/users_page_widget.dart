...
class _UsersPageWidgetState extends State<UsersPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.usersOnLoad = await UsersTable().queryRows(
        queryFn: (q) => q.order('id'),
      );
      _model.usersPageListTable = _model.usersOnLoad!.toList().cast<UsersRow>();
      setState(() {});
    });
                  ...
                  child: Padding(
                    ...
                    child: FutureBuilder<List<DepartmentsRow>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<DepartmentsRow> mainContentDepartmentsRowList =
                            snapshot.data!;
                        return Container(
                                                            ...
                                                            builder: (context) {
                                                              ...
                                                              return FlutterFlowDataTable<
                                                                              ...
                                                                              builder: (context) => Padding(
                                                                                ...
                                                                                child: FlutterFlowIconButton(
                                                                                  ...
                                                                                  onPressed: () async {
                                                                                        ...
                                                                                        return Dialog(
                                                                                          ...
                                                                                          child: GestureDetector(
                                                                                            ...
                                                                                            child: EditUserWidget(
                                                                                              parameterUserQueryEdit: usersItem,
                                                                                              departments: mainContentDepartmentsRowList,
                                                                                              selectedDepartment: usersItem.department!,
                                                                                              isAdmin: usersItem.userType == 'Admin' ? true : false,
                                                                                            ),
                                                                                          ),
                                                                                        );
                                                                                      },
                                                                                    ...
                                                                                    _model.refreshUsersTable = await UsersTable().queryRows(
                                                                                      queryFn: (q) => q.order('id', ascending: true),
                                                                                    );
                                                                                    _model.usersPageListTable = _model.refreshUsersTable!.toList().cast<UsersRow>();
                                                                                    setState(() {});
                                                                ...
                                                                onSortChanged:
                                                                    (columnIndex,
                                                                        ascending) async {
                                                                  _model.usersPageListTable = functions
                                                                      .sortUserList(
                                                                          _model
                                                                              .usersPageListTable
                                                                              .toList(),
